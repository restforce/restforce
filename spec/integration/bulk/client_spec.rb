...
shared_examples_for Restforce::Bulk::Client do
  describe '.create_job' do
    requests 'jobs/ingest', method: :post,
                            fixture: 'bulk/create_job_success_response'
  ...
  describe '.close_job' do
    requests 'jobs/ingest/0123456789', method: :patch,
                                       fixture: 'bulk/close_job_success_response'
  ...
  describe '.success_results' do
    ...
    it {
      should match_array [
        {
          'sf__Id' => '0012f000007uKgsAAE',
          'sf__Created' => 'true',
          'Name' => 'Foo Bar'
        },
        {
          'sf__Id' => '0012f000007uKgtAAE',
          'sf__Created' => 'true',
          'Name' => 'Bizz Buzz'
        }
      ]
